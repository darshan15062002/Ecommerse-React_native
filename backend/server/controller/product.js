...
export const getScript = asyncError(async (req, res, next) => {
    ...
    const prompt = `Generate a script in hindi lnaguage for a promotional video featuring a new product. The product is a  with the following key features: ${productDescription}. Emphasize its benefits and make the script engaging and informative. generate in way so that it directly use in with speak function`
